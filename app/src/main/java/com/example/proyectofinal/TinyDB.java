...
public class TinyDB {
    ...
    public ArrayList<plato_lista> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<plato_lista> objects =  new ArrayList<plato_lista>();

    	for(String jObjString : objStrings){
    		plato_lista value  = gson.fromJson(jObjString,  plato_lista.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<plato_lista> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(plato_lista obj : objArray){
